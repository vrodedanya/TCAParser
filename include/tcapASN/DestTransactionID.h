...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_DestTransactionID_constr_1;
...
per_type_decoder_f DestTransactionID_decode_uper;
per_type_encoder_f DestTransactionID_encode_uper;

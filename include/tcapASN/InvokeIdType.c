...
int
InvokeIdType_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
asn_per_constraints_t asn_PER_type_InvokeIdType_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8, -128,  127 }	/* (-128..127) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const ber_tlv_tag_t asn_DEF_InvokeIdType_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_InvokeIdType = {
	...
	sizeof(asn_DEF_InvokeIdType_tags_1)
		/sizeof(asn_DEF_InvokeIdType_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_InvokeIdType_constr_1, InvokeIdType_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};

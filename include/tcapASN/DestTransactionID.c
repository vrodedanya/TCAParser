...
int
DestTransactionID_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
asn_per_constraints_t asn_PER_type_DestTransactionID_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
static const ber_tlv_tag_t asn_DEF_DestTransactionID_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_DestTransactionID = {
	...
	{ 0, &asn_PER_type_DestTransactionID_constr_1, DestTransactionID_constraint },
	0, 0,	/* No members */
